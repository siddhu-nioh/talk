...
import "./User.css";
import { FaEdit, FaTrash, FaUsers, FaShare, FaEnvelope, FaSignOutAlt } from "react-icons/fa"; 
    ...
    <div className="profile-page">
      <div className="profile-container">
        ...
        <div className="action-buttons">
          ...
          <div className="btn-actions" onClick={handleLogout} style={{ color: "red", cursor: "pointer" }}>
            <FaSignOutAlt />
          </div>
        </div>
